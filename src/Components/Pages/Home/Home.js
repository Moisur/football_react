        ...
        <div>
            <div className="grid  bg-style grid-cols-1 lg:grid-cols-2 gap-4  px-10  md:pt-32">
                <div className='md:pt-20 '>
                    ...
                    <Link to='/details' className=' text-white text-xl font-bold py-4 px-16 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-500 shadow-md'>
                        Plyers
            ...
            <div className='p-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16 text-center '>
                {
                    data.slice(0, 7).map(plyers => <Plyer key={plyers.idPlayer} plyers={plyers}></Plyer>)
                }
            </div>
            <Link to='/details' className=' text-white text-xl font-bold py-4 ml-10 px-16 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-500 shadow-md'>
                Seen
                <span className='px-2'><FontAwesomeIcon icon={faArrowRight}></FontAwesomeIcon></span>
            </Link>
        </div>
