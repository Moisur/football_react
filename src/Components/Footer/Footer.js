...
const Footer = () => {
    return (
        <div className="p-4 mt-20 sm:p-6 bg-gray-400 ">
            <div className="md:flex md:justify-between">
                <div className="mb-6 md:mb-0">
                    <Link  to='/' href="https://flowbite.com" className="flex items-center">
                        <img src={require('../img/football-logo1.png')} className="mr-3 h-8" alt="FlowBite Logo" />
                        <span className="self-center text-3xl font-mono text-white whitespace-nowrap ">Flowbite</span>
                    </Link>
                </div>
                <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    <div>
                        ...
                        <ul className="text-white">
                            <li className="mb-4">
                                <Link  to='/' href="https://flowbite.com" className="hover:underline">Flowbite</Link>
                            </li>
                            <li>
                                <Link  to='/' href="https://tailwindcss.com/" className="hover:underline">Tailwind CSS</Link>
                            </li>
                        </ul>
                    </div>
                    <div>
                        ...
                        <ul className="text-white">
                            <li className="mb-4">
                                <Link  to='/' href="https://github.com/themesberg/flowbite" className="hover:underline ">Github</Link>
                            </li>
                            <li>
                                <Link  to='/' href="https://discord.gg/4eeurUVvTy" className="hover:underline">Discord</Link>
                            </li>
                        </ul>
                    </div>
                    <div>
                        ...
                        <ul className="text-white">
                            <li className="mb-4">
                                <Link  to='/' href="#" className="hover:underline">Privacy Policy</Link>
                            </li>
                            <li>
                                <Link  to='/' href="#" className="hover:underline">Terms &amp; Conditions</Link>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div className="sm:flex sm:items-center sm:justify-between">
                <span className="text-sm text-white sm:text-center ">© 2022 <Link  to='/' href="https://flowbite.com" className="hover:underline">Flowbite™</Link>. All Rights Reserved.
                </span>
